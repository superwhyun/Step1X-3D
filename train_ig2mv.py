...
def main(args, extras) -> None:
    ...
    from step1x3d_texture.systems.base import BaseSystem
    from step1x3d_texture.utils.callbacks import (
        CodeSnapshotCallback,
        ConfigSnapshotCallback,
        CustomProgressBar,
        ProgressCallback,
    )
    from step1x3d_texture.utils.config import ExperimentConfig, load_config
    from step1x3d_texture.utils.core import find
    from step1x3d_texture.utils.misc import get_rank, time_recorder
    from step1x3d_texture.utils.typing import Optional
